...
int weapon_t::get_max_tickbase_shift()
{
	...
	if (g_cfg.ragebot.dt_mode == 0)
	{
		...
		case WEAPON_G3SG1:
		case WEAPON_SCAR20:
			max_tickbase_shift = g_cfg.ragebot.Double_tap_offensive_ticks;
			break;
		}
	}
	else if (g_cfg.ragebot.dt_mode == 1)
	{
		switch (idx)
		{
		case WEAPON_KNIFE:
		...
		case WEAPON_G3SG1:
		case WEAPON_SCAR20:
			max_tickbase_shift = g_cfg.ragebot.Double_tap_defensive_ticks;
			break;
		}
	}
	else if (g_cfg.ragebot.dt_mode == 2)
	{
		switch (idx)
		{
		case WEAPON_KNIFE:
		...
		case WEAPON_NEGEV:
		case WEAPON_MP9:
			max_tickbase_shift = g_cfg.ragebot.weapon[hooks::rage_weapon].Double_tap_ticks_custom;
			break;
		case WEAPON_ELITE:
		case WEAPON_UMP45:
		case WEAPON_BIZON:
